...
PARAM_HELP: Dict[str, dict] = {
    ...
    "employees.source_url_timeout_s": {
        ...
        "help": "Сколько секунд ждать ответа от сервера-источника. Отсчёт идёт и на соединение, и на чтение данных.",
    ...
    "employees.create_accounts": {
        ...
        "help": "Создавать почтовый ящик для сотрудника, у которого в файле указан e-mail. Ящик создаётся ВЫКЛЮЧЕННЫМ и без пароля: копирование не начнётся, пока администратор не впишет пароль и не включит ящик. Если ящик с таким логином уже есть, он просто привязывается к сотруднику.",
    ...
    "employees.account_host": {
        ...
        "help": "Адрес почтового сервера, который подставляется в автоматически создаваемые ящики сотрудников.",
