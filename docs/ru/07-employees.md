...
| HTML внутри ячейки («Отдел &lt;span&gt;(ЧЛБ)&lt;/span&gt;») | Разметка убирается, остаётся текст |
...
Файл — **XLSX**, **CSV** или XML-таблица из двух колонок: адрес ящика и пароль. Заголовки
(«email», «пароль») можно не писать: если первая строка уже похожа на пару «адрес — пароль», она
читается как данные.
