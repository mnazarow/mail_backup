...
Добавьте её в «Пропускать папки» в карточке ящика — тогда копия перестанет помечаться неполной из-за
папки, которую на сервере всё равно не восстановить.</div>
